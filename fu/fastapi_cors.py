...
"""
本文件复制自   from fastapi.middleware.cors import CORSMiddleware

这个实现的缺点是，如果抛出了异常，就没有设置header跨域访问
修改方式是，添加try catch，无论如何设置好header，然后继续抛出异常。
"""
...
class CORSMiddleware:
    ...
    async def simple_response(
        ...
        try:
            ...
            await self.send(scope, send, request_headers)
            raise ex
